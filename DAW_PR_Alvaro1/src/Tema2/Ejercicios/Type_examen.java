...
public class Type_examen {
	...
	public static void main(String[] args) {
		...
		String nombre[], fecha[] = { "" }, categoria[] = { "" }, formato[] = { "" }, plataforma[] = { "" },lista1[] = { "" },lista2[] = { "" };
		...
		for (int i = 0; i < n; i++) {
			...
			if(formato[i].equals("digital")) {
				contadordig++;
			}else if(formato[i].equals("play4")) {   //contadores de formatos XXXXXXXXXXX Faltan por dividir entre n cada uno y mutilipcar por precio
				contadorfis++;
			}
		}
